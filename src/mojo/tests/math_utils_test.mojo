...
fn test_smooth_clamp_basic():
    var lower_bound: Float64 = 0.0
    var upper_bound: Float64 = 10.0
    var soft_width:  Float64 = 2.0
...
fn test_smooth_clamp_quintic_vs_cubic():
    var lower_bound2: Float64 = 0.0
    var upper_bound2: Float64 = 10.0
    var soft_width2:  Float64 = 2.0
    # pick a point in lower band with t=0.25 → x = lo + 0.25*soft = 0.5
    var sample_value  : Float64 = lower_bound2 + 0.25 * soft_width2
    var cubic_value : Float64 = MathUtils.smooth_clamp(sample_value, lower_bound2, upper_bound2, soft_width2, "cubic")
    var quintic_value : Float64 = MathUtils.smooth_clamp(sample_value, lower_bound2, upper_bound2, soft_width2, "quintic")
